...
do(%rs,%sort,class) ; 
 ...
 . S %ok=(object=class)
 . Q:'%ok
 . S caption=$P(^oSysSchema(%i1),$C(31),$G(^dxSysSchema("caption"),0))
 ...
 . S %rs(shortname)=%rs(shortname)_$C(31)_caption
 . S %rs(shortname)=%rs(shortname)_$C(31)_datatype
 . S %rs(shortname)=%rs(shortname)_$C(31)_extra
 . S %sort(shortname,%i1)=1
 . Q
 Q
 ;
